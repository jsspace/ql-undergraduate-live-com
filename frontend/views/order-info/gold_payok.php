...
<!--                    应付金额：<span class="orange">￥--><?//= $order_amount ?><!--</span>-->
                </div>
                <div class="grey">
    ...
    <div class="order-payment-method payway-method">
        <div class="inner-order">
            ...
            <ul class="method-list">
                <li class="ipay active"><a href="<?= Url::to(['order-info/gold_alipay', 'order_sn' => $order_sn]) ?>"></a></li>
                <li class="wechat-pay"><a href="<?= Url::to(['order-info/gold_wxpay', 'order_sn' => $order_sn]) ?>"></a></li>
            </ul>
        </div>
    </div>
