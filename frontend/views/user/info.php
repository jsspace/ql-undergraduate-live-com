    ...
    <div class="right-content">
        <div class="info-wrapper">
            <p class="info-img">
                ...
                <span class="info-txt"><img src="/img/user.jpg"/></span>
            </p>
            <p class="info-name">
                <span class="info-label">姓名：</span>
                <span class="info-txt">张三</span>
            </p>
            <p class="info-phone">
                <span class="info-label">电话：</span>
                <span class="info-txt">13243234567</span>
            </p>
            <p class="info-email">
                <span class="info-label">邮箱：</span>
                <span class="info-txt">13022@qq.com</span>
            </p>
            <p class="info-btn">
                <a href="/user/edit" class="edit-btn">修改</a>
            </p>
        </div>
    </div>
</div>