...
/**
 * SchoolSearch represents the model behind the search form about `backend\models\User`.
 */
class SchoolSearch extends User
{
    /**
     * @inheritdoc
     */
    ...
    {
        $school_ids = Yii::$app->authManager->getUserIdsByRole('school');
        $query = User::find()
        ->where(['in', 'id', $school_ids]);
