...
class OrderInfo extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['order_sn', 'consignee', 'mobile', 'email', 'pay_name', 'discount'], 'required'],
            [['user_id', 'order_status', 'pay_status', 'pay_id', 'integral', 'add_time', 'confirm_time', 'pay_time', 'bonus_id', 'is_separate', 'parent_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'mobile' => Yii::t('app', '收货人的手机，用户页面填写，默认取值于表user_address'),
            'email' => Yii::t('app', '收货人的手机，用户页面填写，默认取值于表user_address'),
