...
-- Generation Time: 2017-12-24 06:42:04
-- 服务器版本： 5.6.35
-- PHP Version: 5.6.30
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员表类型';
...
(13, '市场专员管理', NULL, '/market/index', 7, NULL),
...
(24, '订单管理', NULL, '/order-info/index', 7, NULL),
(25, '考本资料', NULL, '/data/index', 15, NULL),
(26, '教师答疑', NULL, '/quas/index', 16, NULL),
(27, '友情链接', NULL, '/friendly-links/index', 17, NULL),
(30, '会员类型管理', NULL, '/member/index', 8, NULL),
(31, '会员订单管理', NULL, '/member-order/index', 9, NULL),
...
--
-- 使用表AUTO_INCREMENT `tbl_member`
--
ALTER TABLE `tbl_member`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- 使用表AUTO_INCREMENT `tbl_member_order`
--
ALTER TABLE `tbl_member_order`
